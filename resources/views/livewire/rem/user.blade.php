...
<tr> <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $row->name}}</td>
 ...
 <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $row->last name}}</td>
 ...
 <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $row->google id}}</td>
...
<div><label class='block'><span class='text-gray-700 @error('last_name') text-red-500  @enderror'>Last name</span><input type='text' class='mt-1 block w-full rounded-md border-gray-300 shadow-sm @error('last_name')  border-red-500 @enderror focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50' wire:model='last_name'>@error('last_name')<span class='text-red-500 text-sm'>{{ $message }}</span>@enderror</label></div>
<div><label class='block'><span class='text-gray-700 @error('email') text-red-500  @enderror'>Email</span><input type='email' class='mt-1 block w-full rounded-md border-gray-300 shadow-sm @error('email')  border-red-500 @enderror focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50' wire:model='email'>@error('email')<span class='text-red-500 text-sm'>{{ $message }}</span>@enderror</label></div>
<div><label class='block'><span class='text-gray-700 @error('password') text-red-500  @enderror'>Password</span><input type='password' class='mt-1 block w-full rounded-md border-gray-300 shadow-sm @error('password')  border-red-500 @enderror focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50' wire:model='password'>@error('password')<span class='text-red-500 text-sm'>{{ $message }}</span>@enderror</label></div>
<div><label class='block'><span class='text-gray-700 @error('google_id') text-red-500  @enderror'>Google id</span><input type='text' class='mt-1 block w-full rounded-md border-gray-300 shadow-sm @error('google_id')  border-red-500 @enderror focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50' wire:model='google_id'>@error('google_id')<span class='text-red-500 text-sm'>{{ $message }}</span>@enderror</label></div>
