...
<div class="messenger">
        ...
        <div class="m-body contacts-container">
           ...
           <div class="@if($type == 'group') show @endif messenger-tab groups-tab app-scroll" data-view="groups">
                ...
                <p style="text-align: center;color:grey;margin-top:30px">
                    <a target="_blank" style="color:{{$messengerColor}};" href="https://chatify.munafio.com/notes#groups-feature">Click aquí</a> para mas información
                </p>
             </div>
           ...
           <div class="messenger-tab search-tab app-scroll"app-scroll" data-view="search">
                ...
                <div class="search-records">
                    <p class="message-hint center-el"><span>Escriba un criterio...</span></p>
                </div>
             </div>
        </div>
    </div>
    ...
    <div class="messenger-messagingView">
        ...
        <div class="internet-connection">
            ...
            <span class="ic-noInternet">Algo salió mal</span>
        </div>
        {{-- Messaging area --}}
        <div class="m-body messages-container app-scroll">
            <div class="messages">
                <p class="message-hint center-el"><span>Seleccione un contacto...</span></p>
            </div>
            {{-- Typing indicator --}}
