                    ...
                    <div class="col-lg-7 ps-0 my-auto">
                        <div class="card-body text-left">
                            <div class="p-md-0 pt-3">
                                <h5 class="font-weight-bolder mb-0">Juan Pablo Lugo</h5>
                                <p class="text-uppercase text-sm font-weight-bold mb-2">Director</p>
                                <p class="text-uppercase text-sm font-weight-bold mb-2">Fundación ACUDE</p>
                            </div>
                    ...
                    <div class="col-lg-7 ps-0 my-auto">
                        <div class="card-body text-left">
                            <div class="p-md-0 pt-3">
                                ...
                                <p class="text-uppercase text-sm font-weight-bold mb-2">Coordinador</p>
                                <p class="text-uppercase text-sm font-weight-bold mb-2">Fundación PRUEBA</p>
                            </div>
                            <p class="mb-4">Success is not final, failure is not fatal: it is the courage to continue that counts...</p>
                            <button type="button" class="btn btn-facebook btn-simple btn-lg mb-0 pe-3 ps-2">
                                <i class="fab fa-facebook" aria-hidden="true"></i>
            ...
            <div class="card card-profile card-plain">
                <div class="row">
                    ...
                    <div class="col-lg-7 ps-0 my-auto">
                        <div class="card-body text-left">
                            <div class="p-md-0 pt-3">
                                <h5 class="font-weight-bolder mb-0">NOMBRE APELLIDO</h5>
                                <p class="text-uppercase text-sm font-weight-bold mb-2">Prueba</p>
                            </div>
                            <p class="mb-4">Success is not final, failure is not fatal: it is the courage to continue that counts...</p>
                            <button type="button" class="btn btn-facebook btn-simple btn-lg mb-0 pe-3 ps-2">
                                <i class="fab fa-facebook" aria-hidden="true"></i>
