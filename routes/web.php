...
use App\Http\Livewire\Commerces;
...
use App\Http\Livewire\rem\Users;
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/commerces', Commerces::class)->name('commerces');
    Route::post('/commerces', Commerces::class)->name('form-commerces');
